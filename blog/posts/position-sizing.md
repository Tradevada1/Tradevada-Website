---
title: Position sizing: how much to risk on a single trade
slug: position-sizing
description: A bad position size will kill an account faster than a bad strategy. The framework professional traders use to make sure no single trade can sink the ship.
date: 2026-06-12
tag: Stocks
read_minutes: 7
hero_image: /img/blog/position-sizing.jpg
---
...
1. Decide right now: what's your max per-trade risk? Write it down. 1% is conservative, 2% is aggressive, anything more is gambling.
2. Before every trade, calculate your stop loss and the dollar amount you'd lose if it triggers.
3. Divide your max risk by your per-share risk to get the share count.
4. If the math says "I can only afford 7 shares," that's the right answer. Don't round up to 100.
