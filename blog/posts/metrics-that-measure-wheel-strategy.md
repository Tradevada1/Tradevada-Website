...
Of the premium you collect when you open, how much do you keep when the trade ends? Expire worthless: 100%. Buy back at half: 50%. Roll a loser for years: often negative, even though every individual roll "felt" fine. Capture rate is the single best measure of trade management, and it's invisible unless something tracks open credit against closing debit on every chain.
...
Total gross profit divided by total gross loss. A wheel with a 90% win rate and a profit factor below 1 is a slow leak with good vibes. Anything sustained above 1.5 means your winners genuinely outrun your losers. It's the fastest way to compare two strategies that both "feel like they're working."
